...
export default function GetStartedSection() {
  return (
    <section className="relative flex flex-col items-center bg-primary-coral">
      <div className="flex w-[90%] flex-col items-center pt-[8.3rem] text-center text-secondary-green-darkest sm:h-[20rem] sm:flex-row sm:justify-center sm:gap-[4%] sm:p-0 lg:max-w-[111rem]">
